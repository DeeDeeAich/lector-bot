...
class Pages(commands.Cog):
    def __init__(self, bot):
        ...
        self.help_page.description += f'\n{pre}[armenian|a|arm|armen] [*Bible version*] (print|normal)'
        self.help_page.description += f'\n{pre}[catholic|c|cath] [*Bible version*] (print|normal)'
        self.help_page.description += f'\n{pre}[orthodox|o|orth|ortho] [*Bible version*] (print|normal)'
        self.help_page.description += f'\n{pre}[rcl|r|revised|prot|protestant] [*Bible version*] (print|normal)'
        self.help_page.description += '\n\n**Subscriptions (Requires Manage Messages)**'
        self.help_page.description += f'\n{pre}[subscribe|sub] [a|c|o|r] [*Bible version*] [print|normal] (#channel)'
