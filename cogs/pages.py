...
class Pages(commands.Cog):
    def __init__(self, bot):
        ...
        self.help_page.description += f'\n{pre}[armenian|a|arm|armen] (print|normal)'
        self.help_page.description += f'\n{pre}[catholic|c|cath] (print|normal)'
        self.help_page.description += f'\n{pre}[orthodox|o|orth|ortho] (print|normal)'
        self.help_page.description += f'\n{pre}[rcl|r|revised|prot|protestant] (print|normal)'
        self.help_page.description += '\n\n**Subscriptions (Requires Manage Messages)**'
        self.help_page.description += f'\n{pre}[subscribe|sub] [a|c|o|r] [print|normal] (#channel)'
